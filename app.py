...
VERSION = "2.4.2-fast-gateway-aligned"
HOST = "0.0.0.0"
PORT = int(os.getenv("PORT", "8081"))
DB_PATH = os.getenv("DB_PATH", "mexc_routes_v242.db")
...
def _live_client_id(attempt_id, purpose, variant=""):
    ...
    return ("v242"+tag+vt+attempt_id.replace("-","")[-22:])[:32]
...
def process_live_candidate(q):
    ...
    _schedule_bot_shadows_from_gateway(q,x,quality,admitted_ts,tested)
    record_check()
...
HTML=r'''<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>MEXC 2-Leg V2.4.2</title>
...
<h2>MEXC — Scanner + micro-bot Spot 2-leg V2.4.2</h2><div class=cards id=cards></div>
...
def bootstrap():
    ...
    put_db(("meta",("v242_private_gateway",json.dumps({"mode":TRADING_MODE,"live_cap_usd":LIVE_CAP_USD,
        "capital_limit_usd":LIVE_CAPITAL_LIMIT_USD,"daily_loss_limit_usd":LIVE_DAILY_LOSS_LIMIT_USD,
        ...
        "retry_window_ms":LIVE_RETRY_WINDOW_MS,"retry_interval_ms":LIVE_RETRY_INTERVAL_MS,"retry_max":LIVE_RETRY_MAX,
        "account_refresh_sec":LIVE_ACCOUNT_REFRESH_SEC,"account_cache_max_age_ms":LIVE_ACCOUNT_CACHE_MAX_AGE_MS,
        "admission_db_mode":"async_before_attempt","bot_shadow_admission":"fresh_gateway_A_or_Bplus",
