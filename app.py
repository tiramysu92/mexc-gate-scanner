...
# ============================================================
# MEXC <-> Gate spot arbitrage scanner V3.2
...
def api_state():
    ...
    with state_lock:
        return jsonify({
            "version":"3.2","pairs":state["pairs"],"pair_count":len(state["pairs"]),
...
def main():
    ...
    start_mexc_ws()
    print(f"[V3.2] Dashboard http://0.0.0.0:{APP_PORT}")
